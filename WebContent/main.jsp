...
<body>
	<div class="container">
		<form action="Controller" method="post">
			...
			<c:out value="${login}" />
			<div class="dws-input"><input type="text" name="login" value="${login}" required/></div>
		
			<c:out value="${password}" /><br/>
			<div class="dws-input"><input type="password" name="password" value="${password}" required /></div>	
		...
		<form action="Controller" method="post">
			...
			<div class="button"><input type="submit" name="entrance" value="${registration}" /></div>
		</form>
	</div>
