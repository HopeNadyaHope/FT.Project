...
public class CourseDAOImpl implements CourseDAO{	
	...
	/*
	 * private final String FIND_STUDENT_COURSES =
	 * "SELECT running_courses.id, courses.courseName, courses.description " +
	 * "FROM courses " +
	...
	private static final String FIND_TEACHER_COURSES ="SELECT running_courses.id, courses.courseName, courses.description " + 
			"FROM courses " + 
			"JOIN running_courses ON courses.id = running_courses.courses_id " + 
	...
	public List<RunningCourse> findStudentCourses(int userID) throws DAOException {
		...
		try {
			...
			while(resultSet.next()) {//мб отдельно создавать обьект runningCourse?
				...
				System.out.println(Integer.parseInt(resultSet.getString(ID)));
				//start
				//end
